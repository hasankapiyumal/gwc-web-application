...
<div class="row">
    <!-- <div class="row row-cols-1 row-cols-md-4 g-4">
        <?php
                               $data_new= DATABASE::search("SELECT * FROM product WHERE category_id='".$text."';");
    ...
    <div class="row row-cols-1 row-cols-md-4 g-4">
            ...
            $productrs = Database::search("SELECT * FROM product WHERE category_id='".$text."' AND  status_id ='1';");
            ...
            $data_new = DATABASE::search("SELECT * FROM product WHERE category_id='".$text."' AND  status_id ='1'  LIMIT " . $results_per_page . " OFFSET " . $page_first_result . "  ;");
            $new_data_row = $data_new->num_rows;
