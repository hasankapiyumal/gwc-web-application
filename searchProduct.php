...
for ($i = 0; $i < $row; $i++) {
    ...
    $product_img = Database::search("SELECT * FROM `product_images` WHERE `product_id` = '" . $u["id"] . "' ORDER BY `id` DESC LIMIT 1 ");
...
?>
    ...
    <div class="row mt-1">
        ...
        ?>
        <div class="col-lg-4 bg-warning fw-bold p-2 d-none d-lg-block" data-toggle="tooltip" title="This is a tooltip">
        ...
        <div class="col-lg-2 col-4  bg-warning fw-bold p-2">
            <span><?php echo $u['price']; ?></span>
        </div>
        <div class="col-lg-2 bg-dark text-white fw-bold p-2 d-none d-lg-block">
            <span><?php echo $u['product_date']; ?></span>
        </div>
        <div class="col-3 col-lg-1 bg-warning fw-bold p-2 ">
            <button class="btn btn-primary" type="button" onclick="productDetails(<?php echo $uid; ?>)">More</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" id="view">
                <!-- <?php
                $product_imges = Database::search("SELECT * FROM `product_images` WHERE `product_id` = '" . $uid . "' ORDER BY `id` DESC LIMIT 1 ");

                $pim = $product_imges->fetch_assoc();
                ?>
                <img src="<?php echo $pid["image"]; ?>" class="img-fluid" width="200px;" height="150px;">
                <?php
